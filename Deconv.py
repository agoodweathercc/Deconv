...
l_pool4 = MaxPool2DLayer(l_conv3_3, pool_size=(2, 2), stride=2, pad=0)

l_conv5_1 = Conv2DLayer(l_pool3, num_filters=512, filter_size=(3, 3), stride=1, pad=1, flip_filters=False, nonlinearity=rectify, W=lasagne.init.Normal(0.01))
...
l_fc6_deconv = Deconv2DLayer(l_fc7, num_filters=512, filter_size=(7,7),stride=1, pad=0, nonlinearity=rectify, W=lasagne.init.Normal(0.01))

l_unpool5 = InverseLayer(l_fc6_deconv, l_pool5)

l_deconv5_1 = Deconv2DLayer(l_unpool5, num_filters=512, filter_size=(3,3), stride=1, pad=1, nonlinearity=rectify, W=lasagne.init.Normal(0.01))
l_deconv5_2 = Deconv2DLayer(l_deconv5_1, num_filters=512, filter_size=(3,3),stride=1, pad=1, nonlinearity=rectify, W=lasagne.init.Normal(0.01))
l_deconv5_3 = Deconv2DLayer(l_deconv5_2, num_filters=512, filter_size=(3,3), stride=1, pad=1, nonlinearity=rectify, W=lasagne.init.Normal(0.01))

l_unpool4 = InverseLayer(l_deconv5_3, l_pool4)

l_deconv4_1 = Deconv2DLayer(l_unpool4, num_filters=512, filter_size=(3,3), stride=1, pad=1, nonlinearity=rectify, W=lasagne.init.Normal(0.01))
l_deconv4_2 = Deconv2DLayer(l_deconv4_1, num_filters=512, filter_size=(3,3), stride=1, pad=1, nonlinearity=rectify, W=lasagne.init.Normal(0.01))
l_deconv4_3 = Deconv2DLayer(l_deconv4_2, num_filters=256, filter_size=(3,3), stride=1, pad=1, nonlinearity=rectify, W=lasagne.init.Normal(0.01))

l_unpool3 = InverseLayer(l_deconv4_3, l_pool3)

l_deconv3_1 = Deconv2DLayer(l_unpool3, num_filters=256, filter_size=(3,3), stride=1, pad=1, nonlinearity=rectify, W=lasagne.init.Normal(0.01))
l_deconv3_2 = Deconv2DLayer(l_deconv3_1, num_filters=256, filter_size=(3,3), stride=1, pad=1, nonlinearity=rectify, W=lasagne.init.Normal(0.01))
l_deconv3_3 = Deconv2DLayer(l_deconv3_2, num_filters=128, filter_size=(3,3), stride=1, pad=1, nonlinearity=rectify, W=lasagne.init.Normal(0.01))

l_unpool2 = InverseLayer(l_deconv3_3, l_pool2)

l_deconv2_1 = Deconv2DLayer(l_unpool2, num_filters=128, filter_size=(3,3), stride=1, pad=1, nonlinearity=rectify, W=lasagne.init.Normal(0.01))
l_deconv2_2 = Deconv2DLayer(l_deconv2_1, num_filters=64, filter_size=(3,3), stride=1, pad=1, nonlinearity=rectify, W=lasagne.init.Normal(0.01))

l_unpool1 = InverseLayer(l_deconv2_2, l_pool1)

l_deconv1_1 = Deconv2DLayer(l_unpool1, num_filters=64, filter_size=(3,3), stride=1, pad=1, nonlinearity=rectify, W=lasagne.init.Normal(0.01))
l_deconv1_2 = Deconv2DLayer(l_deconv1_1, num_filters=64, filter_size=(3,3), stride=1, pad=1, nonlinearity=rectify, W=lasagne.init.Normal(0.01))
